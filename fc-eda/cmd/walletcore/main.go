...
func main() {
	...
	// db.Exec("Create table clients (id varchar(254), name varchar(255), email varchar(255), created_at date)")
	// db.Exec("Create table accounts (id varchar(254), client_id varchar(255), balance int, created_at date)")
	// db.Exec("Create table transactions (id varchar(254), account_id_from varchar(255), account_id_to varchar(255), amount int, created_at date)")
